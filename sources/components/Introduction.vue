	...
	<section class="introduction">
		<div id="introduction" class="introduction__container">
			<header class="introduction__header">
				...
				<a id="download_windows" href="https://github.com/alexisfontaine/starred/releases/download/v0.4.1/RealEase-x64.exe" class="button" title="Windows 64-bit v0.4.1 (.exe)" download>
				...
				<a id="download_macos" href="https://github.com/alexisfontaine/starred/releases/download/v0.4.1/RealEase-x64.dmg" class="button" title="macOS 64-bit v0.4.1 (.dmg)" download>
